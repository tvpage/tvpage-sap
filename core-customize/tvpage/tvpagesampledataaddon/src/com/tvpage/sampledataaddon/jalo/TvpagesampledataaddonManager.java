 ...
 */
package com.tvpage.sampledataaddon.jalo;
...
import com.tvpage.sampledataaddon.constants.TvpagesampledataaddonConstants;



/**
 * This is the extension manager of the Tvpagesampledataaddon extension.
 */
public class TvpagesampledataaddonManager extends GeneratedTvpagesampledataaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TvpagesampledataaddonManager.class.getName());
	 ...
	 */
	public static TvpagesampledataaddonManager getInstance()
	{
		return (TvpagesampledataaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TvpagesampledataaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TvpagesampledataaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TvpagesampledataaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TvpagesampledataaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TvpagesampledataaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
