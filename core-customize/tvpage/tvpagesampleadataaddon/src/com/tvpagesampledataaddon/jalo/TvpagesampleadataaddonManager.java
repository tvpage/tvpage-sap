 ...
 */
package com.tvpagesampledataaddon.jalo;
...
import com.tvpagesampledataaddon.constants.TvpagesampleadataaddonConstants;



/**
 * This is the extension manager of the Tvpagesampleadataaddon extension.
 */
public class TvpagesampleadataaddonManager extends GeneratedTvpagesampleadataaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TvpagesampleadataaddonManager.class.getName());
	 ...
	 */
	public static TvpagesampleadataaddonManager getInstance()
	{
		return (TvpagesampleadataaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TvpagesampleadataaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TvpagesampleadataaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TvpagesampleadataaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TvpagesampleadataaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TvpagesampleadataaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
